jQuery(document).ready(function ($) {
  ...
  // Upload Background image of casino/bookmaker/game page - Start
      ...
      custom_uploader = wp
        ...
        .on('select', function () {
          ...
          $(button)
            .removeClass('button')
            .html(
              '<img class="aces-background-admin-image" src="' +
                attachment.url +
  ...
  // Upload Background image of casino/bookmaker/game page - End
})
