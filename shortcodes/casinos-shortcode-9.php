									...
									<div class="space-organizations-8-archive-item-buttons box-100 relative">
										<div class="space-organizations-8-archive-item-buttons-left box-50 text-center relative">
											...
											<div class="space-organizations-8-archive-item-button-one box-100 relative">
												<a href="#" title="<?php echo esc_attr( $permalink_button_title ); ?>"><?php echo esc_html( $permalink_button_title ); ?></a>
											</div>
										...
										<div class="space-organizations-8-archive-item-buttons-right box-50 text-center relative">
											<div class="space-organizations-8-archive-item-button-two relative">
												<a href="#" title="<?php echo esc_attr( $button_title ); ?>" <?php if ($external_link) { ?>target="_blank" rel="nofollow"<?php } ?>><?php echo esc_html( $button_title ); ?></a>
											</div>
										</div>
									</div>
